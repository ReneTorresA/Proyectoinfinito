...
function Main() {
    ...
    <hr className="my-5" />
            ...
            <div className="row mt-5 pt-4 mb-1">
                ...
                <div className="card h-100 animacion">
                ...
                <div className="card-body text-center">
                    ...
                    <NavLink to="/calculo3" className="btn stretched-link btn-warning"> Ir al curso</NavLink>
                </div>
                </div>
                </div>
                ...
                <div className="card-body text-center">
                    ...
                    <NavLink to="/python" className="btn stretched-link btn-warning">Ir al curso</NavLink></div>
                </div>
                </div>

                <div className="col-md-4 mb-1 mt-5">

                <div className="card animacion h-100">
                ...
                <div className="card-body text-center">
                    ...
                    <NavLink to="/fisica" className="btn stretched-link btn-warning">Ir al Curso</NavLink>
